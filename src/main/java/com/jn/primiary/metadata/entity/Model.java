...
public class Model {
	...
	@Column(name = "dbtype", nullable = true, length = 128)
	private String dbtype = "";// locadbtypetion

	@Column(name = "extension", nullable = true, length = 128)
	...
	@Column(name = "datasourceId", nullable = true, length = 512)
	private String datasourceId;// datasourceId

	@Column(name = "materiaParams", nullable = true, length = 512)
	private String materiaParams;// materiaParams
	...
	public String getMateriaParams() {
		return materiaParams;
	}

	public void setMateriaParams(String materiaParams) {
		this.materiaParams = materiaParams;
	}
